(function() {
    window.app = window.angular.module('Demo', [
        'ui.bootstrap',
        'sx.wizard'
    ]);

    app.controller('HomeController', function($scope, $wizard) {
        $scope.data = {
            username: 'shaun',
        ...
        var wizard = $wizard
            ...
            .addStep({
                id: 'step-1-welcome',
                title: 'Welcome',
                templateUrl: 'steps/step-01-welcome.html'
            })
            .addStep({
                id: 'step-2-update-data',
                title: 'Update data, entering and validating',
                templateUrl: 'steps/step-02-update-data.html',
            ...
            .addStep({
                ...
                templateUrl: 'steps/step-03-config-next.html',
            ...
            .addStep({
                ...
                templateUrl: 'steps/step-05-custmize-nav.html',
                controller: 'wizardStepCustmizeNavCtrl'
            })
            .addStep({
                id: 'step-6-summary',
                title: 'Summary',
                templateUrl: 'steps/step-06-summary.html'
            });
